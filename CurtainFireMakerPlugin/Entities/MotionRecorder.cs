...
namespace CurtainFireMakerPlugin.Entities
{
    ...
    {
        void AddBoneKeyFrame(World world, PmxBoneData bone, Vector3 pos, Quaternion rot, CubicBezierCurve posCurve, int frameTime, bool replace = true);

        void AddMorphKeyFrame(World world, PmxMorphData morph, float weight, int frameTime, bool replace = true);
    }
    ...
    public class VmdMotionRecorder : IMotionRecorder
    {
        ...
        public void AddBoneKeyFrame(World world, PmxBoneData bone, Vector3 pos, Quaternion rot, CubicBezierCurve posCurve, int frameTime, bool replace = true)
        {
        ...
        public void AddMorphKeyFrame(World world, PmxMorphData morph, float weight, int frameTime, bool replace = true)
        {
